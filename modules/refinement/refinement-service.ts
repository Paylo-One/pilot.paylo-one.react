...
export const MOCK_REFINEMENT_RULES: readonly RefinementRule[] = [
  {
    ...
    ruleType: "priority",
    scopeType: "person",
    scopeId: "person_randy",
    scopeLabel: "Randy Coburn",
    statement: "Always treat Randy Coburn as high priority.",
    priority: 80,
    status: "active",
  ...
  },
  {
    ...
    ruleType: "topic_link",
    scopeType: "person",
    scopeId: "person_jacques",
    scopeLabel: "Jacques Becker",
    statement: "Link Jacques Becker's messages to the Payments migration project.",
    priority: 60,
    status: "active",

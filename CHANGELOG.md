...
- Confirmed Daily Memo-to-action handoffs now preserve the memo section's inspectable source references and remain single-effect when a submission is retried.

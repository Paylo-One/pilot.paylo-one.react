...
- Action history now distinguishes user-confirmed Daily briefing handoffs, Pilot suggestions, and other known origins instead of labelling every non-manual action as AI extraction.

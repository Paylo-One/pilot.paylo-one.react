...
| **Premium credibility gap** | A CTO comparing €149/mo to a human chief of staff has cheaper AI assistants and bundled tools one tap away | Anchor explicitly to premium personal software and fractional-CoS / executive-coaching spend, *never* commodity SaaS. Make the altitude/discretion justification land in the first session. Personal Operator (€49) and Executive Operator (€149) sit inside the personal-card / no-approval zone; reserve hands-on onboarding + security review for bespoke higher-capacity cases and Enterprise. |
| **Pricing drift after governance decision** | Governance now sets Personal Operator / Executive Operator public at launch, Enterprise inquiry, and Command future/manual; stale single-tier or public-Command copy would undercut premium seriousness | Keep app copy aligned to `../governance/docs/13-decision-log/2026-07-11-launch-billing-surface.md`; keep founding operators at 30% off for the lifetime of a continuous subscription. |
